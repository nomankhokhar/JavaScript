...
// In Regular function call this keyword set to undefined then we need to use bind methods
...
class App {
  ...
  _newWorkout(e) {
    // Function to check if all inputs are valid finite numbers
    ...
    // Workout object on map as marker
